      ...
      <div class="lyh-form-card" id="listHotelForm" style="margin-top: 0;">
        ...
        <div style="display:flex;border-bottom:2px solid #f0ebe4;margin-bottom:20px">
          <button onclick="szShowTab('register')" id="tab-register"
            style="flex:1;padding:14px;border:none;background:none;font-family:'Poppins',sans-serif;font-size:13px;font-weight:800;color:#e31e24;border-bottom:2px solid #e31e24;margin-bottom:-2px;cursor:pointer;transition:.2s">
            <i class="fas fa-user-plus" style="margin-right:5px"></i> Register
          </button>
          <button onclick="szShowTab('login')" id="tab-login"
            style="flex:1;padding:14px;border:none;background:none;font-family:'Poppins',sans-serif;font-size:13px;font-weight:800;color:#94a3b8;border-bottom:2px solid transparent;margin-bottom:-2px;cursor:pointer;transition:.2s">
        ...
        <form action="{{ route('vendor.signup_submit') }}" method="POST">
            ...
            <div class="lyh-field">
                ...
                <input type="text" id="location" name="location" placeholder="City / Area" value="{{ old('location') }}">
                @error('location')
                  <p class="text-danger mt-2">{{ $message }}</p>
                @enderror
            </div>

            {{-- Original Laravel Fields (Required for Signup) --}}
            <div class="lyh-field">
...
// Auto-switch to login tab if URL has ?tab=login
