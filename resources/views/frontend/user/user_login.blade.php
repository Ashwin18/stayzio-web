  ...
  <div class="sz-auth-wrap">
    ...
    <section class="sz-login-card">
      ...
      <div class="sz-form-panel active" id="szPanelPassword">
        <form action="{{ route('user.login_submit') }}" method="POST" autocomplete="off">
          @csrf

          <div class="sz-field">
            <label class="sz-label">Email Id</label>
            <input class="sz-input" type="email" name="email" value="{{ old('email') }}" placeholder="Enter Email Id" required autocomplete="username">
            @error('username') 
          ...
          <div class="sz-field" style="margin-bottom: 8px;">
            ...
            <input class="sz-input" type="password" name="password" placeholder="Enter password" required autocomplete="current-password">
            @error('password') 
                <span class="error-text">{{ $message }}</span> 
            @enderror
          </div>
