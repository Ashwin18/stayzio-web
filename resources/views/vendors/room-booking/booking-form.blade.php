...
@section('page','New Booking')
@section('content')
<div class="page-hdr">
  <div class="page-hdr-left"><h2>New Booking</h2></div>
  <div class="page-hdr-actions">
    <a href="{{ route('vendor.room_bookings.all_bookings',['language'=>$defaultLang->code]) }}" class="btn btn-secondary btn-sm"><i class="ti ti-arrow-left"></i> Back</a>
  </div>
</div>
  @php
