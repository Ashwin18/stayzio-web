      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create"
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="icon" placeholder="e.g. fas fa-shopping-bag">
            <p style="font-size:11px;color:#888;margin-top:4px">Font Awesome class name — browse icons at <a href="https://fontawesome.com/search?o=r&m=free" target="_blank">fontawesome.com</a>. Shown on the homepage if no photo is uploaded below.</p>
