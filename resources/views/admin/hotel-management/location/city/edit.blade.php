<form id="ajaxEditForm" class="modal-form" action="{{ route('admin.hotel_management.location.update_city') }}"
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="icon" id="in_icon" placeholder="e.g. fas fa-shopping-bag">
    <p style="font-size:11px;color:#888;margin-top:4px">Font Awesome class name — browse icons at <a href="https://fontawesome.com/search?o=r&m=free" target="_blank">fontawesome.com</a>.</p>
...
<div style="padding-top:16px;text-align:right;border-top:1px solid var(--border);margin-top:8px">
