...
Route::prefix('vendor')->middleware('auth:vendor', 'Demo', 'Deactive', 'email.verify', 'vendorLang')->group(function () {
  ...
  Route::prefix('hotel-management')->group(function () {
    ...
    // Hourly Inventory (Vendor)
    Route::get('/hourly-inventory', [\App\Http\Controllers\Vendor\VendorHourlyInventoryController::class, 'index'])->name('vendor.hotel.inventory.index');
    Route::post('/hourly-inventory/update', [\App\Http\Controllers\Vendor\VendorHourlyInventoryController::class, 'updateInline'])->name('vendor.hotel.inventory.update_inline');
  ...
  Route::prefix('room-bookings')->group(function () {
    ...
    Route::get('/calendar', 'Vendor\RoomBookingController@calendarView')->name('vendor.room_bookings.calendar');
    Route::get('/calendar-data', 'Vendor\RoomBookingController@calendarData')->name('vendor.room_bookings.calendar_data');
    ...
    // report route
    Route::get('/report', 'Vendor\RoomBookingController@report')->name('vendor.room_bookings.report');
    Route::get('/export-report', 'Vendor\RoomBookingController@exportReport')->name('vendor.room_bookings.export_report');
  });
  ...
  // ── Vendor Properties ──
  Route::get('/properties', 'Vendor\\VendorPropertyController@index')->name('vendor.properties.index');
  Route::get('/properties/create', 'Vendor\\VendorPropertyController@create')->name('vendor.properties.create');
  Route::post('/properties/store', 'Vendor\\VendorPropertyController@store')->name('vendor.properties.store');
  Route::get('/properties/{id}', 'Vendor\\VendorPropertyController@show')->name('vendor.properties.show');
  Route::get('/properties/{id}/prices', 'Vendor\\VendorPropertyController@editPrices')->name('vendor.properties.edit_prices');
  Route::post('/properties/{id}/prices', 'Vendor\\VendorPropertyController@updatePrices')->name('vendor.properties.update_prices');
});
