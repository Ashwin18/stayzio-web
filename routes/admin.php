...
use App\Http\Controllers\Admin\HotelManagement\HourlyInventoryController;
...
Route::prefix('/admin')->middleware('auth:admin', 'Demo', 'adminLang')->group(function () {
  ...
  Route::prefix('room-bookings')->middleware('permission:Room Bookings')->group(function () {
    ...
    // report route
    Route::get('/report', 'Admin\RoomBookingController@report')->name('admin.room_bookings.report');

    Route::get('/export-report', 'Admin\RoomBookingController@exportReport')->name('admin.room_bookings.export_report');
  });
  // Room Bookings Routes END

  //========Hotels Management//
  Route::prefix('hotel-management')->middleware('permission:Hotels Management')->group(function () {
      // Hourly Inventory
      Route::get('/hourly-inventory', 'Admin\\HotelManagement\\HourlyInventoryController@index')->name('admin.hotel_management.hourly_inventory.index');
      Route::post('/hourly-inventory/update', 'Admin\\HotelManagement\\HourlyInventoryController@updateInline')->name('admin.hotel_management.inventory.update_inline');

    // settings route
    // Hotel approval
    Route::get('/pending-hotels', 'Admin\HotelManagement\HotelController@pendingHotels')->name('admin.hotel_management.pending_hotels');
    Route::post('/approve-hotel/{id}', 'Admin\HotelManagement\HotelController@approveHotel')->name('admin.hotel_management.approve_hotel');
    Route::post('/reject-hotel/{id}', 'Admin\HotelManagement\HotelController@rejectHotel')->name('admin.hotel_management.reject_hotel');
    ...
    // Hotel Master Data — Perks, Policies, Restrictions
    Route::prefix('master-data')->group(function () {
      Route::get('/', 'Admin\HotelManagement\HotelMasterDataController@index')
          ->name('admin.hotel_management.master_data.index');
      Route::post('/perk/store',             'Admin\HotelManagement\HotelMasterDataController@storePerk')
          ->name('admin.hotel_management.master_data.perk.store');
      Route::post('/perk/update',            'Admin\HotelManagement\HotelMasterDataController@updatePerk')
          ->name('admin.hotel_management.master_data.perk.update');
      Route::post('/perk/delete/{id}',       'Admin\HotelManagement\HotelMasterDataController@destroyPerk')
          ->name('admin.hotel_management.master_data.perk.delete');
      Route::post('/policy/store',           'Admin\HotelManagement\HotelMasterDataController@storePolicy')
          ->name('admin.hotel_management.master_data.policy.store');
      Route::post('/policy/update',          'Admin\HotelManagement\HotelMasterDataController@updatePolicy')
          ->name('admin.hotel_management.master_data.policy.update');
      Route::post('/policy/delete/{id}',     'Admin\HotelManagement\HotelMasterDataController@destroyPolicy')
          ->name('admin.hotel_management.master_data.policy.delete');
      Route::post('/restriction/store',      'Admin\HotelManagement\HotelMasterDataController@storeRestriction')
          ->name('admin.hotel_management.master_data.restriction.store');
      Route::post('/restriction/update',     'Admin\HotelManagement\HotelMasterDataController@updateRestriction')
          ->name('admin.hotel_management.master_data.restriction.update');
      Route::post('/restriction/delete/{id}','Admin\HotelManagement\HotelMasterDataController@destroyRestriction')
          ->name('admin.hotel_management.master_data.restriction.delete');
    });
  ...
  Route::get('/nearby-areas', 'Admin\HotelManagement\Location\CityController@nearbyAreas')->name('admin.hotel_management.location.nearby_areas');
  Route::post('/nearby-areas/save', 'Admin\HotelManagement\Location\CityController@saveNearbyAreas')->name('admin.hotel_management.location.nearby_areas.save');
  Route::get('/nearby-areas', 'Admin\HotelManagement\Location\CityController@nearbyAreas')->name('admin.hotel_management.location.nearby_areas');
  Route::post('/nearby-areas/save', 'Admin\HotelManagement\Location\CityController@saveNearbyAreas')->name('admin.hotel_management.location.nearby_areas.save');
      });
    });
    ...
    Route::post('bulk-sort', 'Admin\HotelManagement\HotelController@bulkSort')->name('admin.hotel_management.bulk_sort.hotel');
    Route::get('/popularity-order', 'Admin\HotelManagement\HotelController@popularityOrder')->name('admin.hotel_management.popularity_order');
    Route::get('/popularity-order', 'Admin\HotelManagement\HotelController@popularityOrder')->name('admin.hotel_management.popularity_order');
    ...
    //Featured hotels 
    Route::prefix('/feature-hotel')->group(function () {
  ...
  Route::prefix('rooms-management')->middleware('permission:Rooms Management')->group(function () {
    ...
    Route::get('/booking-id-settings', 'Admin\BookingIdSettingsController@index')->name('admin.settings.booking_id');
    Route::post('/booking-id-settings/update', 'Admin\BookingIdSettingsController@update')->name('admin.settings.booking_id.update');
  ...
  Route::prefix('/notifications')->group(function () {
    Route::get('/', 'Admin\\AdminNotificationController@index')->name('admin.notifications.index');
    Route::get('/dropdown', 'Admin\\AdminNotificationController@dropdown')->name('admin.notifications.dropdown');
    Route::get('/read/{id}', 'Admin\\AdminNotificationController@markRead')->name('admin.notifications.read');
    Route::post('/mark-all-read', 'Admin\\AdminNotificationController@markAllRead')->name('admin.notifications.mark_all_read');
    Route::delete('/{id}', 'Admin\\AdminNotificationController@destroy')->name('admin.notifications.destroy');
    Route::post('/clear-read', 'Admin\\AdminNotificationController@clearRead')->name('admin.notifications.clear_read');
  });


  // ── Property Submissions ──
  Route::prefix('/property-submissions')->group(function () {
    Route::get('/', 'Admin\\PropertySubmissionController@index')->name('admin.property_submissions.index');
    Route::get('/{id}', 'Admin\\PropertySubmissionController@show')->name('admin.property_submissions.show');
    Route::post('/{id}/approve', 'Admin\\PropertySubmissionController@approve')->name('admin.property_submissions.approve');
    Route::post('/{id}/reject', 'Admin\\PropertySubmissionController@reject')->name('admin.property_submissions.reject');
  });
});
