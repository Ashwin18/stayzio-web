...
class VendorController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $counter = 1;
        while (\App\Models\Vendor::where('username', $username)->exists()) {
        ...
        if ($setting->vendor_admin_approval == 0) {
            $in['status'] = 1;
        }

        $in['password'] = Hash::make($request->password);
        // Save extra registration fields
        if ($request->filled('hotel_name')) $in['hotel_name'] = $request->hotel_name;
        if ($request->filled('contact_person_name')) $in['contact_person_name'] = $request->contact_person_name;
        if ($request->filled('mobile_number')) $in['phone'] = $request->mobile_number;
        if ($request->filled('location')) $in['location'] = $request->location;
        if ($request->filled('city_id')) $in['city_id'] = $request->city_id;
        ...
        if ($vendor) {
            $membership = Membership::create([
                ...
                'currency_symbol' => '₹',
                'payment_method' => 'CASH',
                'transaction_id' => '45566767',
                'status' => 1,
                'transaction_details' => "offline",
                'settings' => '{"id":2,"uniqid":12345,"favicon":"6a0aff3700568.png","logo":"6a0a995a1800d.png","logo_two":"64ed7071b1844.png","website_title":"Stayzio","email_address":"timestay@example.com","contact_number":"+70133","address":"450 Young Road, New York, USA","theme_version":1,"base_currency_symbol":"\u20b9","base_currency_symbol_position":"right","base_currency_text":"INR","base_currency_text_position":"left","base_currency_rate":"1.00","primary_color":"C6834B","smtp_status":1,"smtp_host":"smtp.gmail.com","smtp_port":587,"encryption":"TLS","smtp_username":"ranaahmed269205@gmail.com","smtp_password":"afiw ynhq tjuj vdwa","from_mail":"ranaahmed269205@gmail.com","from_name":"Multi Booking","to_mail":"example@example.com","breadcrumb":"6641d13fcffde.jpg","disqus_status":0,"disqus_short_name":null,"google_recaptcha_status":0,"google_recaptcha_site_key":"1","google_recaptcha_secret_key":"1","whatsapp_status":0,"whatsapp_number":"+8811111111111","whatsapp_header_title":"Hi,there","whatsapp_popup_status":1,"whatsapp_popup_message":"If you have any issues, let us know.","maintenance_img":"1632725312.png","maintenance_status":0,"maintenance_msg":"We are upgrading our site. We will come back soon. \r\nPlease stay with us.\r\nThank you.","total_earning":9,"bypass_token":"azim","footer_logo":"677511ec6df9e.png","footer_background_image":"66a1e5bc9ee81.jpg","admin_theme_version":"light","notification_image":"619b7d5e5e9df.png","google_adsense_publisher_id":"dvf","equipment_tax_amount":"5.00","hotel_tax_amount":5,"self_pickup_status":1,"two_way_delivery_status":1,"guest_checkout_status":0,"hotel_view":0,"room_view":0,"facebook_login_status":0,"facebook_app_id":"1","facebook_app_secret":"1","google_login_status":0,"google_client_id":"1","google_client_secret":"1","google_map_api_key":"1","google_map_api_key_status":0,"radius":500000,"tawkto_status":0,"tawkto_direct_chat_link":".","vendor_admin_approval":0,"vendor_email_verification":1,"admin_approval_notice":"Your account is deactive or pending now. Please Contact with admin!","expiration_reminder":3,"timezone":"Asia\/Dhaka","hero_section_video_url":"https:\/\/www.youtube.com\/watch?v=9l6RywtDlKA","contact_title":"Get Connected","contact_subtile":"How Can We Help You?","contact_details":"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores pariatur a ea similique quod dicta ipsa vel quidem repellendus, beatae nulla veniam, quaerat veritatis architecto. Aliquid doloremque nesciunt nobis, debitis, quas veniam.\r\n\r\nLorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores a ea similique quod dicta ipsa vel quidem repellendus, beatae nulla veniam, quaerat.","latitude":"23.21","longitude":"90.3785693","preloader_status":1,"preloader":"673b11564dea9.gif","time_format":12,"about_section_image":"6753c1ab4183e.png","hero_section_image":"674bcea685119.png","feature_section_image":"674bcebb407a3.png","counter_section_image":"674bcf2dec7d8.jpg","call_to_action_section_image":"674bcf2decaeb.jpg","call_to_action_section_inner_image":"6753e46fe0ee6.png","testimonial_section_image":"6753e40c0e036.jpg","updated_at":"2026-05-20T10:22:18.000000Z"}',
                'package_id' => 9,
                'vendor_id' => $vendor->id,
        ...
        return view('frontend.vendor.auth.register_success', $information);
    ...
    public function login(Request $request)
    {
        ...
        try {
            \App\Models\AdminNotification::fire(
                ...
                url('admin/vendor-management/vendors')
            );
        } catch(\Exception $e) {}
    ...
    public function authentication(Request $request)
    {
        ...
        $vendorRecord = \Illuminate\Support\Facades\DB::table('vendors')
            ->where('email', $request->email)->first();
        $usernameToTry = $vendorRecord ? $vendorRecord->username : '';
        ...
        if (Auth::guard('vendor')->attempt([
            ...
            $authAdmin = Auth::guard('vendor')->user();
             ...
             if ($authAdmin->status == 0) {
                 ...
                 Session::flash('error', __('Your Account Not Activate Please Wait for Admin Approval ') . '!');
                 Auth::guard('vendor')->logout();
                 return redirect()->back()->with('error', 'Your Account Not Activate Please Wait For Admin Approval');
    ...
    {
        // Auto-redirect to property form if vendor has no properties
        $vendorId = \Illuminate\Support\Facades\Auth::guard('vendor')->id();
        $propCount = \App\Models\VendorProperty::where('vendor_id', $vendorId)->count();
        if ($propCount === 0) {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            // get all 12 months's room posts
            $carFound = false;
    ...
    public function forget_mail(Request $request)
    {
        ...
        try {
            if ($info->smtp_status == 1 && $mailTemplate && $mailTemplate->mail_status) {
