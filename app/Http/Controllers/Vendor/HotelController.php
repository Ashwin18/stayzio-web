    ...
    public function store(HotelStoreRequest $request)
    {
        ...
        try {
            \App\Models\AdminNotification::fire(
                \App\Models\AdminNotification::TYPE_HOTEL_SUBMITTED,
                'New Hotel Submitted for Approval',
                'Vendor "' . optional(\Auth::guard('vendor')->user())->name . '" submitted a new hotel. Review and approve to make it live.',
                route('admin.hotel_management.pending_hotels', ['language' => 'en'])
            );
        } catch (\Exception $e) {}
