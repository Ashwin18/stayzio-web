...
class HotelController extends Controller
{
    ...
    public function store(HotelStoreRequest $request)
    {
        ...
        if ($current_package != '[]') {
                ...
                foreach ($languages as $language) {
                    ...
                    if (
                        ...
                        if ($language->is_default) {
                            $ri = $request->input('restrictions', []);
                            $sr = [];
                            foreach ($ri as $rid => $rd) {
                                if (!empty($rd['selected'])) $sr[] = ['id' => (int)$rid, 'type' => $rd['type'] ?? 'not_allowed'];
                            }
                            $hotelContent->restrictions = json_encode($sr);
                        }
            ...
            Session::flash('success', __('Please buy a plan to add a hotel') . '!');
