...
class RoomBookingController extends Controller
{
    ...
    public function updatePaymentStatus(Request $request)
    {
        ...
        if ($request->payment_status == '1') {
            ...
            if ($vendor_id == 0) {
                ...
                $commission = $bookingInfo->commission_price;
            }
    ...
    public function report(Request $request)
    {
        ...
        return view('admin.room-booking.report', $information);
    }
    ...
    public function exportReport()
    {
        if (Session::has('product_orders')) {
            ...
            if (count($productOrders) == 0) {
                ...
                return Excel::download(new ReportExport($productOrders), 'report.xlsx');
            }
        } else {
            Session::flash('warning', __('No order found to export') . '!');
