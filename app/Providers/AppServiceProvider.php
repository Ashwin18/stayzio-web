...
class AppServiceProvider extends ServiceProvider
{
  ...
  public function boot()
  {
    ...
    if (!app()->runningInConsole()) {
      # code...
      $data = DB::table('basic_settings')->select('favicon', 'website_title', 'logo', 'base_currency_text', 'base_currency_text_position', 'time_format', 'maintenance_img', 'maintenance_msg', 'google_map_api_key_status')->first();
      $langs = Language::all();
